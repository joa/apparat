 ...
 * 
 */
public final class FindPropStrict extends AbstractOperation
{
	public AbstractMultiname property;

	public FindPropStrict()
	{
		super( Op.FindPropStrict );
	}

	public FindPropStrict( final AbstractMultiname property )
	{
		super( Op.FindPropStrict );
