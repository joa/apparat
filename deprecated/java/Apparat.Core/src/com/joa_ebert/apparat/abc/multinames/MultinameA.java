 ...
 * 
 */
public final class MultinameA extends Multiname
{
	public MultinameA()
	{
		super( MultinameKind.MultinameA );
	}
	...
	{
		if( other instanceof MultinameA )
		{
			return equals( (MultinameA)other );
		}

		return false;
	}

	public boolean equals( final MultinameA other )
	{
