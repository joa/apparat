...
import com.joa_ebert.apparat.abc.bytecode.operations.EscXmlElem;
 ...
 * 
 */
public final class TEscapeXmlElement extends TaasExpression
{
	@TaasReference
	public TaasValue value;

	public TEscapeXmlElement( final TaasValue value )
	{
			...
			final MethodBody body, final Bytecode code )
	{
		...
		code.add( new EscXmlElem() );
	}

	@Override
	public String toString()
	{
		return "[TEscapeXmlElement " + value.toString() + "]";
	}
}
