...
public class LzmaAlone
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		if (params.Command == CommandLine.kBenchmak)
		{
			...
			apparat.sevenzip.LzmaBench.LzmaBenchmark(params.NumBenchmarkPasses, dictionary);
		}
		else if (params.Command == CommandLine.kEncode || params.Command == CommandLine.kDecode)
		{
			...
			{
				apparat.sevenzip.compression.lzma.Encoder encoder = new apparat.sevenzip.compression.lzma.Encoder();
			...
			else
			{
				...
				apparat.sevenzip.compression.lzma.Decoder decoder = new apparat.sevenzip.compression.lzma.Decoder();
