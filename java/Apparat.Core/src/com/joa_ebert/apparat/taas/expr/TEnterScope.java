 ...
 * 
 */
public class TEnterScope extends TaasExpression
{
	@TaasReference
	public TaasValue scope;

	public TEnterScope( final TaasValue scope )
	{
	...
	{
		scope.emit( environment, body, code );
	...
	{
		return "[TEnterScope " + scope.toString() + "]";
	}
}
