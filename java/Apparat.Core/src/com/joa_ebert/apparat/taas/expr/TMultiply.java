...
import com.joa_ebert.apparat.abc.bytecode.operations.Multiply;
 ...
 * 
 */
public final class TMultiply extends AbstractBinaryExpr
{
	private static final String OPERATOR = "*";

	public TMultiply( final TaasValue lhs, final TaasValue rhs )
	{
	...
	{
		return new TMultiply( lhs.dup(), rhs.dup() );
	}
