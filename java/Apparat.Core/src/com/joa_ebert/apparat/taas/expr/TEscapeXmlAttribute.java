...
import com.joa_ebert.apparat.abc.bytecode.operations.EscXmlAttr;
 ...
 * 
 */
public final class TEscapeXmlAttribute extends TaasExpression
{
	@TaasReference
	public TaasValue value;

	public TEscapeXmlAttribute( final TaasValue value )
	{
			...
			final MethodBody body, final Bytecode code )
	{
		...
		code.add( new EscXmlAttr() );
	}

	@Override
	public String toString()
	{
		return "[TEscapeXmlAttribute " + value.toString() + "]";
	}
}
