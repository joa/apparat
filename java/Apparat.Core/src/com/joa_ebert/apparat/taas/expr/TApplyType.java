 ...
 * 
 */
public class TApplyType extends AbstractCallExpr
{
	@TaasReference
	public TaasValue object;

	public TApplyType( final TaasValue object, final TaasValue[] parameters )
	{
	...
	{
		return "[TApplyType object: " + object + ", type: "
				+ getType().toString() + "]";
	}
}
