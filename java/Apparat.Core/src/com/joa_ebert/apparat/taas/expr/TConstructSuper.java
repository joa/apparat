 ...
 * 
 */
public class TConstructSuper extends TConstruct
{
	public TConstructSuper( final TaasValue object, final TaasValue[] parameters )
	{
	...
	{
		return "[TConstructSuper " + object.toString() + "]";
	}
}
