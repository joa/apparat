 ...
 * 
 */
public final class RTQNameLA extends AbstractMultiname
{
	public RTQNameLA()
	{
		super( MultinameKind.RTQNameLA );
	}
	...
	{
		if( other instanceof RTQNameLA )
		{
			return equals( (RTQNameLA)other );
		}

		return false;
	}

	public boolean equals( final RTQNameLA other )
	{
		return this == other;
	}
}
