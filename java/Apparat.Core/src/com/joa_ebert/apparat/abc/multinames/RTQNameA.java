 ...
 * 
 */
public final class RTQNameA extends RTQName
{
	public RTQNameA()
	{
		super( MultinameKind.RTQNameA );
	}
	...
	{
		if( other instanceof RTQNameA )
		{
			return equals( (RTQNameA)other );
		}

		return false;
	}

	public boolean equals( final RTQNameA other )
	{
