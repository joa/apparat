 ...
 * 
 */
public class DefineBitsJPEG4Tag extends DefineTag
{
			...
			throws IOException, SwfException
	{
		...
		final int alphaLength = header.length - alphaOffset - 8;
	...
	{
		return "[DefineBitsJPEG4Tag characterId: " + characterId
				+ ", imageLength: " + imageData.length + ", deblock: "
				+ deblock + "]";
	}
