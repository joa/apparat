 ...
 * 
 */
public class SwfOutputStreamBitTest
{
	...
	@Test
	public void testSB00() throws IOException
	{
		output.writeSB( 4 );
		output.flush( true );
		...
		Assert.assertEquals( 4, input.readSB( 4 ) );
	}

	@Test
	public void testSB01() throws IOException
	{
		output.writeSB( 8 );
		output.flush( true );
		...
		Assert.assertEquals( 8, input.readSB( 5 ) );
	}
}
