...
case class AbcRTQNameA(val name: String) extends AbcName(AbcNameKind.RTQNameA)
...
case class AbcMultiname(val name: String, val nsset: AbcNSSet) extends AbcName(AbcNameKind.Multiname)
